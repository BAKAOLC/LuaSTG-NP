...
plus.UTF8ToUTF16LE = UTF8ToUTF16LE
plus.UTF16LEToUTF8 = UTF16LEToUTF8
plus.UTF8ToANSI = UTF8ToANSI
...
plus.DirectoryExists = DirectoryExists
...
plus.CreateDirectory = CreateDirectory

---@class Native.FileInfo
local fInfo = {
    ---是否为文件夹
    isDirectory = false,
    ---名称
...
---@return table<number, Native.FileInfo>
local function EnumFiles(path)
    local ret = {}
    local info = ffi.new("WIN32_FIND_DATAW")
